...
namespace transformer {
    void Adam::set_parameters(const std::vector<autograd::Parameters*> &_parameters) {
        assert(!is_parameters_set());
        parameters.insert(parameters.end(), _parameters.begin(), _parameters.end());
    }

    bool Adam::is_parameters_set() {
